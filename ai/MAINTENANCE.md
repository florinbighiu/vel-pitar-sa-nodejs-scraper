...
```bash
gh issue list --repo florinbighiu/vel-pitar-sa-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say the company name, not the old template
