...
Acest proiect folosește [GitHub Issues](https://github.com/florinbighiu/vel-pitar-sa-nodejs-scraper/issues) pentru a urmări munca.
...
Vezi [toate issue-urile](https://github.com/florinbighiu/vel-pitar-sa-nodejs-scraper/issues).
