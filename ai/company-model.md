...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Vel Pitar") |
| group        | string   | Parent company group (e.g. "Grupo Bimbo") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/florinbighiu/vel-pitar-sa-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)